...
public class SecurityConfig {
    ...
    private final AdsUserDetailsService adsUserDetailsService;

    public SecurityConfig(JwtAuthenticationFilter jwtAuthenticationFilter, AdsUserDetailsService adsUserDetailsService) {
    ...
    public AuthenticationManager authenticationManager(PasswordEncoder passwordEncoder) {
        ...
        provider.setUserDetailsService(adsUserDetailsService);
